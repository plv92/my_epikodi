...
"[project]/node_modules/music-metadata/lib/id3v2/ID3v2ChapterToken.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const ChapterInfo = {
    len: 16,
    get: (buf, off)=>{
        const startOffset = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UINT32_BE"].get(buf, off + 8);
        const endOffset = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UINT32_BE"].get(buf, off + 12);
        return {
            startTime: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UINT32_BE"].get(buf, off),
            endTime: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UINT32_BE"].get(buf, off + 4),
...
"[project]/node_modules/music-metadata/lib/id3v2/FrameHeader.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s({
    "getFrameHeaderLength": (()=>getFrameHeaderLength),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$id3v2$2f$ID3v2ChapterToken$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/music-metadata/lib/id3v2/ID3v2ChapterToken.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$id3v2$2f$FrameHeader$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/music-metadata/lib/id3v2/FrameHeader.js [app-route] (ecmascript)");
;
;
;
;
...
class FrameParser {
        ...
        switch(type !== 'TXXX' && type[0] === 'T' ? 'T*' : type){
            ...
            case 'PCST':
                {
                    let text;
                    try {
                        text = FrameParser.trimNullPadding((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$common$2f$Util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["decodeString"])(uint8Array.subarray(1), encoding));
                    } catch (error) {
            ...
            case 'APIC':
                if (includeCovers) {
                    ...
                    switch(this.major){
                        case 2:
                            pic.format = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$common$2f$Util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["decodeString"])(uint8Array.subarray(0, 3), 'latin1'); // 'latin1'; // latin1 == iso-8859-1;
                            uint8Array = uint8Array.subarray(3);
                            break;
                        case 3:
                        case 4:
                            fzero = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$common$2f$Util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findZero"])(uint8Array, defaultEnc);
                            pic.format = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$common$2f$Util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["decodeString"])(uint8Array.subarray(0, fzero), defaultEnc);
                    ...
                    pic.type = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$id3v2$2f$ID3v2Token$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AttachedPictureType"][uint8Array[0]];
                    uint8Array = uint8Array.subarray(1);
                    fzero = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$common$2f$Util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findZero"])(uint8Array, encoding);
                    pic.description = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$common$2f$Util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["decodeString"])(uint8Array.subarray(0, fzero), encoding);
            ...
            case 'SYLT':
                {
                    ...
                    uint8Array = uint8Array.subarray(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$id3v2$2f$ID3v2Token$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SyncTextHeader"].len);
                    const result = {
                        descriptor: '',
                    ...
                    while(uint8Array.length > 0){
                        ...
                        if (readSyllables) {
                            const timestamp = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UINT32_BE"].get(uint8Array, 0);
                            uint8Array = uint8Array.subarray(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UINT32_BE"].len);
            ...
            case 'POPM':
                {
                    ...
                    const rating = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UINT8"].get(uint8Array, 0);
                    const counterBytes = uint8Array.subarray(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UINT8"].len);
                    output = {
                        email,
                        rating,
                        counter: counterBytes.length > 0 ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$common$2f$Util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["decodeUintBE"])(counterBytes) : undefined
                    };
                    break;
                }
            case 'GEOB':
                {
                    ...
                    const encoding = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$id3v2$2f$ID3v2Token$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TextEncodingToken"].get(uint8Array, 0);
                    uint8Array = uint8Array.subarray(1);
            ...
            case 'WXXX':
                {
                    ...
                    output = {
                        description,
                        url: FrameParser.trimNullPadding((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$common$2f$Util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["decodeString"])(uint8Array, defaultEnc))
                    };
                    break;
                }
            case 'WFD':
            ...
            case 'CHAP':
                {
                    ...
                    fzero = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$common$2f$Util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findZero"])(uint8Array, defaultEnc);
                    const chapter = {
                        label: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$common$2f$Util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["decodeString"])(uint8Array.subarray(0, fzero), defaultEnc),
                        info: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$id3v2$2f$ID3v2ChapterToken$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ChapterInfo"].get(uint8Array, fzero + 1),
                        frames: new Map()
                    };
                    offset += fzero + 1 + __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$id3v2$2f$ID3v2ChapterToken$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ChapterInfo"].len;
                    while(offset < length){
                        const subFrame = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$id3v2$2f$FrameHeader$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readFrameHeader"])(uint8Array.subarray(offset), this.major, this.warningCollector);
                        const headerSize = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$id3v2$2f$FrameHeader$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getFrameHeaderLength"])(this.major);
                        offset += headerSize;
            ...
            case 'CTOC':
                {
                    ...
                    const idEnd = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$common$2f$Util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findZero"])(uint8Array, defaultEnc);
                    const label = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$common$2f$Util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["decodeString"])(uint8Array.subarray(0, idEnd), defaultEnc);
                    offset = idEnd + 1;
                    // Flags
                    ...
                    for(let i = 0; i < entryCount && offset < length; i++){
                        const end = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$common$2f$Util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findZero"])(uint8Array.subarray(offset), defaultEnc);
                        const childId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$common$2f$Util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["decodeString"])(uint8Array.subarray(offset, offset + end), defaultEnc);
    ...
    static readNullTerminatedString(uint8Array, encoding) {
        ...
        const zeroIndex = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$common$2f$Util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findZero"])(valueArray, encoding.encoding);
        if (zeroIndex >= valueArray.length) {
            // No terminator found, decode full buffer remainder
            return {
                text: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$common$2f$Util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["decodeString"])(valueArray, encoding.encoding),
                len: originalLen
            };
        }
...
class ID3v2Parser {
    ...
    parseMetadata(data) {
        ...
        while(true){
            ...
            const frameHeaderLength = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$id3v2$2f$FrameHeader$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getFrameHeaderLength"])(this.id3Header.version.major);
            ...
            const frameHeader = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$id3v2$2f$FrameHeader$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readFrameHeader"])(frameHeaderBytes, this.id3Header.version.major, this.metadata);
...
class AbstractID3Parser extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$common$2f$BasicParser$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BasicParser"] {
    ...
    async parse() {
        try {
            ...
            if (err instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$strtok3$2f$lib$2f$stream$2f$Errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EndOfStreamError"]) {
                debug("End-of-stream");
            } else {
                throw err;
            }
...
class MpegParser extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$id3v2$2f$AbstractID3Parser$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AbstractID3Parser"] {
    ...
    async parseCrc() {
        await this.tokenizer.ignore(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["INT16_BE"].len); // Ignore CRC
        this.offset += __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$token$2d$types$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["INT16_BE"].len;
...
//# sourceMappingURL=node_modules_music-metadata_lib_efd29778._.js.map