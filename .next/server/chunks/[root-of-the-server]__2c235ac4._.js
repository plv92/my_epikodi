...
async function GET() {
    try {
        ...
        const topTracksWithInfo = await Promise.all(topTracks.map(async (item)=>{
        ...
        // Grouper par jour
        const listensByDay = recentListens.reduce((acc, listen)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2c235ac4._.js.map